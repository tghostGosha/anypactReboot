<label for="smscode" style="margin-bottom: 1.5rem;">
    <span>Внимание!
        ...
        <p>Примечание: если в недавнем времени вы проходили авторизацию на сайте Госуслуг, то дальнейшая авторизация может не требовать введения Вами логина/пароля от Госуслуг.</p>
    </span>
</label>