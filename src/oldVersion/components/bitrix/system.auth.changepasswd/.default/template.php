	...
	<table class="data-table bx-changepass-table">
		...
		<tbody>
			...
			<tr>
				...
				<td><input type="password" name="USER_PASSWORD" maxlength="255" value="<?=$arResult["USER_PASSWORD"]?>" autocomplete="off" />
...
<?endif?>
			...
			<tr>
				...
				<td><input type="password" name="USER_CONFIRM_PASSWORD" maxlength="255" value="<?=$arResult["USER_CONFIRM_PASSWORD"]?>" autocomplete="off" /></td>
			</tr>
		...
		<tfoot>
			<tr>
				<td></td>
				<td><input class="btn btn-nfk" type="submit" name="change_pwd" value="<?=GetMessage("AUTH_CHANGE")?>" /></td>
			</tr>
		</tfoot>
	</table>
</form>
