...
<div class="tender cardPact">
	...
	?>
	<?$this->SetViewTarget('modal-forms');?>
	...
	<?$this->EndViewTarget();?>
    <div class="modal fade bd-message-modal-sm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="message_user" action="/response/ajax/add_new_messag_user.php">
                        <input type="hidden" name="login" value="79161123344@yandex.ru">
                        <div class="form-group">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-nfk d-block cardPact-bBtn submit_message">Отправить
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade bd-complaints-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         style="display: none;" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form id="complaints_on_deal" action="/response/ajax/complaints_on_deal.php">
                        <input type="hidden" name="sessid" id="sessid" value="d1374ed790b52777d92bb4e44ec11f7a">
                        <input type="hidden" name="id" value="115217">
                        <div class="complaints_type-select">
                            <lable>Тип нарушения:</lable>
	...
	<? $APPLICATION->IncludeComponent("nfksber:comment.list", ".default", array(
    ...
    <div id="comment_container_list">
        ...
        <script>var bitrixJS = {'USER_ID': '9858', 'IBLOCK_ID': '9', 'ID_SDELKA': '115217'}        </script>
    </div>
	<?/**/?>
</div>