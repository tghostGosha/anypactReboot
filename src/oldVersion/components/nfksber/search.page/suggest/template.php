...
<?if(isset($arResult["REPLACE_SEARCH_QUERY_STR"])):
	?>
	<div class="search-language-guess search-language-guess-replace">
		<?echo GetMessage("REPLACE_SEARCH_QUERY_STR", array("#query#"=>$arResult["REPLACE_SEARCH_QUERY_STR"], "#original_query#"=>$arResult["ORIGINAL_SEARCH_QUERY_STR"]))?>
	</div><br /><?
endif;?>
